...
df = df[(df['Event_Type'] == 'External Inspection') | (df['Event_Type'] == 'Internal Inspection') | (df['Event_Type'] == 'On-Stream Inspection') |
...
app.layout = html.Div(children=[
    ...
    html.H1(children=' Current Inspection Events 2024 '),
    ...
    dcc.Graph(
        ...
        figure={
            ...
            'layout':
            go.Layout(title='Events Inspection', colorway=[], hovermode="closest",
                      bargap=0.15, bargroupgap=0.1,  barmode="stack", height=630,
